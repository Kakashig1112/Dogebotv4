...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*ᴢᴇʀᴏ ᴛᴡᴏ*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Fnk9vRRcSS8L22L8Bq1GyZ', "groupName": `ᴢᴇʀᴏᴛᴡᴏ Bot Inc.`, "footerText": "*ᴢᴇʀᴏ ᴛᴡᴏ*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `zerotwo`,body:"LMAO = XD",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/916909137213`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*zerotwo*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
...
┗━━━━━━━━━━━━━━━━━`
buttons = [
{buttonId:`scbot`, buttonText: {displayText: 'BOT GROUP🔖'}, type: 1},
...
────────────────────`
buttons = [
{buttonId:`sc`,buttonText:{displayText: 'BOT SUPPORT🔖'},type:1},
{buttonId:`owner`, buttonText: {displayText: 'BOT OWNER👤'}, type: 1}
]
const grup = {
    contentText: `${stamtus}`,
...
case 'listmenu':
 ...
 description: `Hi, please choose the menu_`,
 sections: [
                     {
                      "title": `zerotwo`,
 rows: [
...
────────────────────`
buttons = [
{buttonId:`sc`,buttonText:{displayText: 'BOT GROUP'},type:1},
{buttonId:`owner`, buttonText: {displayText: 'BOT OWNER'}, type: 1}
]
const ownerM = {
    contentText: `${stamtus}`,
...
stamtus =`❏ 「 \`\`\`MAKER MENU\`\`\` 」
────────────────────
_example: ${prefix}throne zerotwo_
────────────────────
🔮 ${prefix}write 「 text 」
💖 ${prefix}throne 「 text 」
💖 ${prefix}logoff 「 text 」
...
anu = `──────────────────
   🧧🔮JOIN SUPPORT🔮🧧
──────────────────
  🧧zero two support official 🧧
  https://chat.whatsapp.com/Fnk9vRRcSS8L22L8Bq1GyZ
OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
...
⍟ ────────────────── ⍟`
buttons = [
{buttonId:`scbot`, buttonText: {displayText: 'BOT SUPPORT'}, type: 1},
{buttonId:`owner`, buttonText:{displayText: 'BOT OWNER'},type:1},
]
const stats = {
    contentText: `${stamtus}`,
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY zerotwo`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `zerotwo`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `zerotwo`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
